...
<script src="app/report_pet.js"></script>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<center><h2>สรุปข้อมูลเริ่มเลี้ยง</h2></center>
				<br>
          ...
          <button class="btn btn-warning" onclick="location.href='pagePet.php'">ย้อนกลับ</button>
				</form>
				<br><br>
